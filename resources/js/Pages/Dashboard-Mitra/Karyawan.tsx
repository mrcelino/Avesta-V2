...
export default function Karyawan() {
    ...
    useEffect(() => {
        const fetchKaryawan = async () => {
            ...
            try {
                ...
                const response = await axios.get(`/api/karyawan/warung/${warungId}`, {
                    headers: {
    ...
    const indexOfLastItem = isAll ? karyawan.length : currentPage * itemsPerPage;
                ...
                <div className="overflow-auto rounded-xl border">
                    <table className="w-full text-left table-auto">
                        <thead className="bg-pink text-white">
                            <tr>
                                ...
                                <th className="p-3 font-semibold">Nomor HP</th>
                            ...
                            {currentKaryawan.map((k: any) => (
                                <tr key={k.id} className="border-t">
                                    ...
                                    <td className="p-3 space-x-2">
                                        ...
                                        >
                                            <Trash2 size={16} />
                                            <span>{deleteLoading === k.id ? "Menghapus..." : "Hapus"}</span>
                                        </button>
                                    </td>
                                </tr>
                            ))}
                    ...
                    <div className="p-4 text-sm border-t bg-white flex flex-col md:flex-row justify-between items-center gap-2">
                        <span>
                            ...
                            {Math.min(indexOfLastItem, karyawan.length)} dari {karyawan.length} hasil
                        </span>
            ...
            {showModal && selectedKaryawanId && (
                <div className="fixed inset-0 bg-black/30 flex justify-center items-center z-50">
                    <div className="flex flex-col items-center justify-center bg-white rounded-2xl shadow-xl p-6 w-full max-w-1/3">
                        <h2 className="text-lg font-semibold mb-6">Hapus Karyawan?</h2>
                        <p className="mb-5">
                        ...
                        <div className="flex w-full space-x-3">
                            ...
                            <button
                                onClick={() => handleDelete(selectedKaryawanId)}
